...
public final class TextPatterns {
    ...
    public static final Pattern english2 = Pattern.compile("(\\d{1,2} \\w{3,9} \\d{4}, \\d{1,2}:\\d{1,2} (?:pm|am)), (.+?) : ?(.+)");
    ...
    public static final Pattern englishDate2 = Pattern.compile("(\\d{1,2} \\w{3,9} \\d{4}, \\d{1,2}:\\d{1,2} (?:pm|am)).*");
