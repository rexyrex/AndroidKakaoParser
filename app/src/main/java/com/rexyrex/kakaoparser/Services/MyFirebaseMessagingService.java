...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private static final String TAG = "REXYREX FIREBASE";
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            if(remoteMessage.getData().containsKey("overridePath")){
                sendNotification(msgTitle, msg, remoteMessage.getData().get("overridePath"));
            } else {
                sendNotification(msgTitle, msg, null);
            }
        }
    ...
    private void sendNotification(String title, String messageBody, String path) {
        ...
        if(path!=null){
            intent.putExtra("overridePath", path);
        }
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        .setSmallIcon(R.drawable.kakao_analyzer_icon)
